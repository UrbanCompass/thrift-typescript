...
export interface IGetStruct__Args__Args {
    key: number;
}
export class GetStruct__Args {
    public key: number;
    constructor(args: IGetStruct__Args__Args) {
    ...
    public static read(input: thrift.TProtocol): GetStruct__Args {
        ...
        if (_args.key !== undefined) {
            return new GetStruct__Args(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read GetStruct__Args from input");
        }
    }
}
export interface IGetStruct__Result__Args {
    success?: SharedStruct.SharedStruct;
}
export class GetStruct__Result {
    public success?: SharedStruct.SharedStruct;
    constructor(args?: IGetStruct__Result__Args) {
    ...
    public static read(input: thrift.TProtocol): GetStruct__Result {
        ...
        input.readStructEnd();
        return new GetStruct__Result(_args);
    }
}
export class Client {
    ...
    public send_getStruct(key: number, requestId: number): void {
        ...
        const args: GetStruct__Args = new GetStruct__Args({ key });
        args.write(output);
...
export class Processor {
    ...
    public process_getStruct(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<SharedStruct.SharedStruct>((resolve, reject): void => {
            try {
                const args: GetStruct__Args = GetStruct__Args.read(input);
                input.readMessageEnd();
            ...
            const result: GetStruct__Result = new GetStruct__Result({ success: data });
